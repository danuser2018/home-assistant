...
- **Documento a Auditar**: Ruta del archivo Markdown del refinamiento (ej. `docs/refinements/refinement-mi-feature.md`).
...
- Incompatibilidades con las decisiones documentadas en los ADRs vigentes en el directorio `docs/adr/`.
...
El asistente debe generar un artefacto de reporte en el directorio de la conversación (o en la ruta designada) con la siguiente estructura:
