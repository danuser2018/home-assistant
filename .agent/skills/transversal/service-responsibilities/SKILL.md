...
- **Aislamiento del host:** Los contenedores Docker son ciegos al hardware físico. La captura de micrófonos, la reproducción de altavoces y la lectura de eventos físicos de entrada (como teclado raw HID) residen en exclusiva en el host.
...
- ❌ Duplicar persistencia de bases de datos o lógica de negocio en los daemons nativos del host (`mic-daemon`, `speaker-watchdog`, `hid-daemon`).
